use crate::{
    ...
    notifications::{
        EmailNotificationAttachment, EmailNotificationContent, NotificationContent,
...
impl ResourcesTrackersFetchJob {
                ...
                if let Some(new_revision_with_diff) = new_revision_with_diff {
                    let notification_schedule_result = api
                        ...
                        .schedule_notification(
                            ...
                            Self::build_notification_content(
                                &api.config,
                                &tracker,
    ...
    fn build_notification_content(
        ...
        resources_revision: &WebPageResourcesRevision,
    ) -> NotificationContent {
        let back_link = format!("{}ws/web_scraping__resources", config.public_url);
        let number_of_changes = resources_revision
            .scripts
            .iter()
        ...
        let logo_attachment = EmailNotificationAttachment::inline(
            "secutils-logo",
            "image/png",
        ...
        NotificationContent::Email(EmailNotificationContent::html_with_attachments(
            format!(
                ...
                tracker.name, number_of_changes
            ),
            format!(
                "\"{}\" resources tracker detected {} changes. Visit {} to learn more.",
                tracker.name, number_of_changes, back_link
            ),
            format!(
                r#"
<!DOCTYPE html>
<html>
  <head>
    <title>"{name}" resources tracker detected {number_of_changes} changes</title>
    <meta charset="utf-8">
  ...
  <body>
    <div class="container">
      <h1>"{name}" resources tracker detected {number_of_changes} changes</h1>
      ...
      <p>{back_link}</p>
      <a href="{home}"><img src="cid:secutils-logo" width="89" height="14" /></a>
    </div>
  </body>
</html>"#,
                name = tracker.name,
                home = config.public_url
            ),
            vec![logo_attachment],
        ))
    }
            ...
            (
                ...
                Email(
                    EmailNotificationContent {
                        subject: "Notification: \"tracker-one\" resources tracker detected 2 changes",
                        text: "\"tracker-one\" resources tracker detected 2 changes. Visit http://localhost:1234/ws/web_scraping__resources to learn more.",
                        html: Some(
                            "\n<!DOCTYPE html>\n<html>\n  <head>\n    <title>\"tracker-one\" resources tracker detected 2 changes</title>\n    <meta charset=\"utf-8\">\n    <meta name=\"viewport\" content=\"width=device-width, initial-scale=1\">\n    <style>\n      body {\n        font-family: Arial, sans-serif;\n        background-color: #f1f1f1;\n        margin: 0;\n        padding: 0;\n      }\n      .container {\n        max-width: 600px;\n        margin: 0 auto;\n        background-color: #fff;\n        padding: 20px;\n        border-radius: 5px;\n        box-shadow: 0 0 10px rgba(0, 0, 0, 0.1);\n      }\n      h1 {\n        font-size: 24px;\n        margin-top: 0;\n      }\n      p {\n        font-size: 16px;\n        line-height: 1.5;\n        margin-bottom: 20px;\n      }\n      .navigate-link {\n        display: block;\n        width: 250px;\n        margin: auto;\n        padding: 10px 20px;\n        text-align: center;\n        text-decoration: none;\n        color: #5e1d3f;\n        background-color: #fed047;\n        border-radius: 5px;\n        font-weight: bold;\n      }\n    </style>\n  </head>\n  <body>\n    <div class=\"container\">\n      <h1>\"tracker-one\" resources tracker detected 2 changes</h1>\n      <p>To learn more, visit the <b>Resources Trackers</b> page:</p>\n      <a class=\"navigate-link\" href=\"http://localhost:1234/ws/web_scraping__resources\">Web Scraping → Resources Trackers</a>\n      <p>If the button above doesn't work, you can navigate to the following URL directly: </p>\n      <p>http://localhost:1234/ws/web_scraping__resources</p>\n      <a href=\"http://localhost:1234/\"><img src=\"cid:secutils-logo\" width=\"89\" height=\"14\" /></a>\n    </div>\n  </body>\n</html>",
                        ),
                        attachments: Some(
                            [
