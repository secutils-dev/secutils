...
RUN if [ "$TARGETPLATFORM" = "linux/arm64" ]; \
    then set -x && \
        curl --remote-name-all https://musl.cc/aarch64-linux-musl-cross.tgz https://dl-cdn.alpinelinux.org/alpine/v3.17/main/aarch64/openssl-libs-static-3.0.8-r0.apk && \
        apk add --allow-untrusted openssl-libs-static-3.0.8-r0.apk && \
