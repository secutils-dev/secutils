...
INSERT INTO utils (id, handle, name, keywords, parent_id) VALUES
   ...
   (6, 'certificates', 'Digital Certificates', 'digital certificates x509 X.509 ssl tls openssl public private key encryption', NULL),
   (7, 'certificates__self_signed_certificates', 'Self-signed certificates', 'digital certificates x509 X.509 ssl tls openssl public private key encryption self-signed', 6),
