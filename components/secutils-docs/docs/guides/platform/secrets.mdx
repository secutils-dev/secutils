...
Navigate to **Workspace → Secrets** in the sidebar to manage your secrets. You can:
...
<Steps steps={[
    {
        ...
        caption: <>Navigate to <b>Workspace → Secrets</b> in the sidebar. Click <b>Add secret</b> to create your first secret.</>,
        alt: 'Navigate to Workspace → Secrets and click Add secret.',
    },
    {
