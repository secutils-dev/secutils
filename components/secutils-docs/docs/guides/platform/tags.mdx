...
Navigate to **Settings → Tags** to manage your tag library. You can:
...
<Steps steps={[
    {
        ...
        caption: <>Open the account menu, click <b>Settings</b>, then select the <b>Tags</b> tab. Click <b>Add tag</b> to create your first tag.</>,
        alt: 'Navigate to Settings → Tags and click Add tag.',
    },
    {
