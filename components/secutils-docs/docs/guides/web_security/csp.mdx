...
import cspSample from '@site/static/samples/web-security/csp-secutils-dev.secutils.json';
import cspReportingSample from '@site/static/samples/web-security/csp-reporting.secutils.json';
...
<Steps steps={[
  {
    ...
    caption: <>Navigate to <a href="https://secutils.dev/ws/web_security__csp"><b>Web Security → CSP</b></a> and click <strong>Create policy</strong>.</>,
    alt: 'Navigate to Web Security → CSP and click Create policy.'
  },
  {
      ...
      caption: <>Enter the policy name, configure directives, and click <b>Save</b> to save the policy.<br/><br/>
        <SampleFields
            sample={cspSample}
            entity="contentSecurityPolicies"
            samplePath="web-security/csp-secutils-dev"
            fields={[
...
<Steps steps={[
  {
    ...
    caption: <>Navigate to <a href="https://secutils.dev/ws/web_security__csp"><b>Web Security → CSP</b></a> and click <strong>Import policy</strong>.</>,
    alt: 'Navigate to Web Security → CSP and click Import policy.'
  },
  {
...
1. Navigate to [Web Security → CSP](https://secutils.dev/ws/web_security__csp) and pick the policy you'd like to share
...
<Steps steps={[
    {
        ...
        caption: <>Navigate to <a href="https://secutils.dev/ws/web_security__csp"><b>Web Security → CSP</b></a>, pick the policy you'd like to share, and click <strong>Share</strong>.</>,
        alt: 'Navigate to Web Security → CSP, pick the policy you\'d like to share, and click Share.'
    },
    {
...
<script type="text/javascript" defer>
  (async function main() {
    ...
    },
    {
        ...
        caption: <>Navigate to <a href="https://secutils.dev/ws/web_security__csp"><b>Web Security → CSP</b></a>, click <strong>Create policy</strong>, and configure it to forbid <code>eval()</code>. Click <b>Save</b>.<br/><br/>
            <table className="su-table">
                <tbody>
                <tr><td><b>Name</b></td><td><CodeBlock>CSP Test</CodeBlock></td></tr>
...
<Steps steps={[
    {
        ...
        caption: <>Navigate to <a href="https://secutils.dev/ws/webhooks__responders"><b>Webhooks → Responders</b></a>, click <strong>Create responder</strong>, enable <b>Advanced mode</b>, and configure a responder to collect CSP violation reports. Click <b>Save</b>.<br/><br/>
            <SampleFields
                sample={cspReportingSample}
                entity="responders"
                index={0}
                samplePath="web-security/csp-reporting"
                hideImportButton
                fields={[
                    { label: 'Name', path: 'name' },
    ...
    },
    {
        ...
        caption: <>Navigate to <a href="https://secutils.dev/ws/web_security__csp"><b>Web Security → CSP</b></a>, click <strong>Create policy</strong>, and configure it with the <code>report-uri</code> directive pointing to the reporting responder URL. Click <b>Save</b>.<br/><br/>
            <SampleFields
                sample={cspReportingSample}
                entity="contentSecurityPolicies"
                samplePath="web-security/csp-reporting"
