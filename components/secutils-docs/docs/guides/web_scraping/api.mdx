...
import applicationStateSample from '@site/static/samples/web-scraping/application-state-api-tracker.secutils.json';
import postApiTrackerSample from '@site/static/samples/web-scraping/post-api-tracker.secutils.json';
...
<Steps steps={[
    ...
    },
    {
        ...
        caption: <>Configure the tracker and click <b>Save</b>.<br/><br/>
            <SampleFields
                sample={applicationStateSample}
                entity="apiTrackers"
                samplePath="web-scraping/application-state-api-tracker"
                fields={[
                    { label: 'Name', path: 'name' },
                    { label: 'URL', path: 'retrack.target.requests.0.url' },
                ]}
            /></>,
...
<Steps steps={[
    ...
    },
    {
        ...
        caption: <>Configure the tracker with a POST method and JSON body and click <b>Save</b>.<br/><br/>
            <SampleFields
                sample={postApiTrackerSample}
                entity="apiTrackers"
                samplePath="web-scraping/post-api-tracker"
                fields={[
                    { label: 'Name', path: 'name' },
                    { label: 'URL', path: 'retrack.target.requests.0.url' },
                    { label: 'Method', path: 'retrack.target.requests.0.method' },
                    { label: 'Body', path: 'retrack.target.requests.0.body', language: 'json' },
                ]}
            /></>,
...
| ![Secutils.dev - API tracker execution logs](/img/docs/guides/web_scraping/api_logs_step1_view.png) |
|-----------------------------------------------------------------------------------------------------|

The log table shows the same columns as for [page trackers](/docs/guides/web_scraping/page#view-execution-logs): status, start time, duration, type, retry information, revision size, and error details. Each row can be expanded to reveal the execution phases timeline.
