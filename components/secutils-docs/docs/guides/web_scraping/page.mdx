...
import hackerNewsTrackerSample from '@site/static/samples/web-scraping/hacker-news-tracker.secutils.json';
import worldClockTrackerSample from '@site/static/samples/web-scraping/world-clock-tracker.secutils.json';
import hnResourcesTrackerSample from '@site/static/samples/web-scraping/hacker-news-resources-tracker.secutils.json';
import githubResourcesTrackerSample from '@site/static/samples/web-scraping/github-resources-tracker.secutils.json';
import detectResourceChangesSample from '@site/static/samples/web-scraping/detect-resource-changes.secutils.json';
...
<Steps steps={[
    ...
    },
    {
        ...
        caption: <>Configure the tracker and click <b>Save</b>.<br/><br/>
            <SampleFields
                sample={hackerNewsTrackerSample}
                entity="pageTrackers"
                samplePath="web-scraping/hacker-news-tracker"
                fields={[
                    { label: 'Name', path: 'name' },
                    { label: 'Content extractor', path: 'retrack.target.extractor', language: 'javascript' },
                ]}
            /></>,
...
<Steps steps={[
    ...
    },
    {
        ...
        caption: <>Configure the tracker with an hourly frequency and click <b>Save</b>.<br/><br/>
            <SampleFields
                sample={worldClockTrackerSample}
                entity="pageTrackers"
                samplePath="web-scraping/world-clock-tracker"
                fields={[
                    { label: 'Name', path: 'name' },
                    { label: 'Content extractor', path: 'retrack.target.extractor', language: 'javascript' },
                ]}
...
<Steps steps={[
    ...
    },
    {
        ...
        caption: <>Configure the tracker with a resource-tracking content extractor script and click <b>Save</b>.<br/><br/>
            <SampleFields
                sample={hnResourcesTrackerSample}
                entity="pageTrackers"
                samplePath="web-scraping/hacker-news-resources-tracker"
                fields={[
                    { label: 'Name', path: 'name' },
                    { label: 'Content extractor', path: 'retrack.target.extractor', language: 'javascript' },
                ]}
...
<Steps steps={[
    ...
    },
    {
        ...
        caption: <>Configure a tracker for the GitHub home page and click <b>Save</b>.<br/><br/>
            <SampleFields
                sample={githubResourcesTrackerSample}
                entity="pageTrackers"
                samplePath="web-scraping/github-resources-tracker"
                fields={[
                    { label: 'Name', path: 'name' },
                    { label: 'Content extractor', path: 'retrack.target.extractor', language: 'javascript' },
                ]}
...
<Steps steps={[
    ...
    },
    {
        ...
        caption: <>Create a JavaScript responder that <b>will remain unchanged</b> across revisions and click <b>Save</b>.<br/><br/>
            <SampleFields
                sample={detectResourceChangesSample}
                entity="responders"
                index={0}
                samplePath="web-scraping/detect-resource-changes"
                hideImportButton
                fields={[
                    { label: 'Name', path: 'name' },
                    { label: 'Path', path: 'location.path' },
                    { label: 'Headers', path: 'settings.headers', language: 'http' },
                    { label: 'Body', path: 'settings.body', language: 'javascript' },
                ]}
            /></>,
