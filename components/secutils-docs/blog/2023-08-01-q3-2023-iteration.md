...
description: "Plan for the Secutils.dev Q3 2023 iteration: more configurable certificate templates, scheduled web page resource checks, and shareable content foundations."
slug: q3-2023-iteration
authors: azasypkin
image: https://secutils.dev/docs/img/blog/2023-08-01_q3_2023_iteration.png
tags: [thoughts, overview, technology]
keywords: [secutils.dev, q3 2023 roadmap, certificate templates, scheduled web page checks, page tracker, shareable content, indie hacker iteration]
---
Hello!
...
All three workstreams below shipped and have since evolved well past their original scope:

- **Certificate templates** now support EC, ECDSA, Ed25519/Ed448, importing certificates from a PEM string, a file, or a live URL, and exporting in PKCS#8, PKCS#12, and SEC1 formats. See the [**guide**](https://secutils.dev/docs/guides/digital_certificates/certificate_templates).
- **Scheduled checks** are now provided by the standalone [**Retrack**](https://github.com/secutils-dev/retrack) project, with custom cron schedules, debug runs, screenshots, the Camoufox stealth browser engine, and a Monaco-based diff viewer.
- **Shareable content** is available for certificate templates and CSP policies, see the [**Sharing & collaboration**](/blog/alpha3-release) section of the alpha.3 announcement.
:::
